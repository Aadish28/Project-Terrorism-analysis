...
def create_app_ui():
  ...
  dcc.Dropdown(
        ...
        searchable=True,
        options=month_list,
        style={'border-radius':'40px','width':"50%"},
  ...
  dcc.RangeSlider(
        ...
        marks=year_dict,
              ...
              ,style={'background-image':'url("/assets/terror.jpg")','background-repeat': 'no-repeat','background-size': '100% 100%'})
      ...
      dcc.Tab(label = "Chart Tool", id="chart tool", value="Chart", children=[
          dcc.Tabs(id = "subtabs2", value = "WorldChart",children = [
            ...
            dcc.Dropdown(id="Chart_Dropdown", options = chart_dropdown_values, placeholder="Select option", value = "region_txt", style={'border-radius':'40px','width':"80%"},), 
            html.Br(),
            html.Br(),
            html.Hr(),
